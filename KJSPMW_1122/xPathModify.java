...
public class xPathModify {
    ...
    public static void main(String[] args) {
        try {
            ...
            File inputFile = new File("KJSPMW_1122\\KJSPMW_kurzusfelvetel.xml");
            ...
            saveToFile(doc, "KJSPMW_kurzusfelvetel1.xml");
    ...
    private static void addNewCourse(Document doc, XPath xPath) throws XPathExpressionException {
        Element kurzusokElement = (Element) xPath.compile("/KJSPMW_kurzusfelvetel/kurzusok").evaluate(doc,
                XPathConstants.NODE);
        ...
        oktato.appendChild(doc.createTextNode("Sasvári Péter"));
    ...
    private static void deleteCourse(Document doc, XPath xPath) throws XPathExpressionException {
        Node courseToDelete = (Node) xPath.compile("/KJSPMW_kurzusfelvetel/kurzusok/kurzus[@id='GEIAL120-B']")
    ...
    private static void modifyCourse(Document doc, XPath xPath) throws XPathExpressionException {
        Node courseToModify = (Node) xPath.compile("/KJSPMW_kurzusfelvetel/kurzusok/kurzus[@id='GEMAK234-B']")
                .evaluate(doc, XPathConstants.NODE);
        Element courseElement = (Element) courseToModify;

        // Módosítások
        courseElement.getElementsByTagName("kredit").item(0).setTextContent("4");
        courseElement.getElementsByTagName("hely").item(0).setTextContent("A1. 315 előadó");
        courseElement.getElementsByTagName("idopont").item(0).setTextContent("Szerda 14:00-15:30");
    }
