...
public class DomReadAlternativeKJSPMW
{
    ...
    public static void main(String[] args)
    {
        try
        {
            File inputFile = new File("KJSPMW_kurzusfelvetel.xml");
            ...
            writeDocumentToFile(doc, "KJSPMW_kurzusfelvetel.xml");
            
            System.out.println("The content has been written to KJSPMW_orarend1.xml successfully.");
        }
        catch (Exception e)
        {
            e.printStackTrace();
